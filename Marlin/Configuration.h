...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 176.38
  #define DEFAULT_bedKi 33.85
  #define DEFAULT_bedKd 612.73
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.1, 80.05, 400, 100 }
...
#define XY_PROBE_FEEDRATE (133*40)
